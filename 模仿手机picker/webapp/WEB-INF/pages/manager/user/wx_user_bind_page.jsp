...
<div class="shopmanmain wx_guanlian bghui" id="pageView" style="display:none">
	...
	<div class="shopmanmain wx_guanlian wxgl_input_plus">
		...
		<ul class="wxgl_input wxgl_input_box ">
			<li  class=" txtcenter"><input name="username" type="text" placeholder="请输入姓名" autocomplete="off"  minlength="2"    maxlength="10"></li>
			<li class=" txtcenter"><input name="phone" type="text" placeholder="请输入手机号码" autocomplete="off"  maxlength="11"></li>
