...
<body data-user-id="${userId}"  data-status="${status}" data-open-id="${openId}"  data-app-id="${appId}"  data-shop-id="${shopId}" data-card-id="${cardId}" data-card-type="${cardType}" data-access-token="${ accessToken }">
...
<div class="shopmanmain wx_guanlian bghui" id="pageView" style="display:none">
	...
	<div class="shopmanmain wx_guanlian wxgl_input_plus">
		...
		<ul class="wxgl_input wxgl_input_box ">
			<li  class=" txtcenter"><input name="username" type="text" placeholder="请输入姓名" autocomplete="off" maxlength="10"></li>
...
<script src="<%=request.getContextPath()%>/resources/javascript/manager/user/duplicate/wx_user_bind_page.js"></script>
